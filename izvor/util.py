...
class GeoMixinHelp():
  ...
  def pomoć(self, dog = None):
    ...
    showinfo('Pomoć',
             ...
             ' ili opcija iz menija), ispraviti figuru nalaženjem'
             ' konveksnog omota (srednji klik ili opcija) i odabrati'
             ' transformaciju iz padajućeg menija, njene parametre,'
             ' kao i to da li je u pitanju inverzna promena.\n\n'
